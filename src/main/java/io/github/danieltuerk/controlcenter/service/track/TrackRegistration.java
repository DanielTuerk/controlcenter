...
import io.github.danieltuerk.controlcenter.shared.viewer.TrackPartStateEvent;
import io.github.danieltuerk.selectrix4java.bus.BusAddressBitListener;
import io.github.danieltuerk.selectrix4java.bus.BusListener;
...
public class TrackRegistration {
     ...
     * register and to call from {@link io.github.danieltuerk.selectrix4java.data.BusDataChannel}.
     */
