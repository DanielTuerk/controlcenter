...
public class SignalSvgBuilder {
     ...
     */
    public void addSvgContent(Signal.TYPE signalType, Signal.FUNCTION function, OMSVGDocument doc, OMSVGSVGElement svg) {
     ...
     */
    private void addTwoTopAndBottom(OMSVGDocument doc, OMSVGSVGElement svg, String topLightColor, String
            bottomLightColor, boolean left) {
