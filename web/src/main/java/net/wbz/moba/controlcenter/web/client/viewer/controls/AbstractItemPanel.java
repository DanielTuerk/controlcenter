 ...
 * <p/>
 * It contains an header panel with an collapse function to extend the details container. Implementations can modify the
 * header and show the details.
 *
 * @author Daniel Tuerk
 */
abstract public class AbstractItemPanel<Model extends AbstractDto, StateEvent extends AbstractStateEvent>
    ...
    public void init() {
        PanelCollapse collapseContentPanel = createCollapseContentPanel();

        // header
        panelHeader = new PanelHeader();
        Panel headerPanelContent = createHeaderPanel();
